...
const inputClass =
  "w-full rounded border border-line-strong bg-panel px-3 py-2 text-sm text-ink shadow-xs placeholder:text-faint focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent-ring/40";
